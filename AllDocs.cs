 ...
 namespace A2J_Calc
{
    public static class AllDocs
    {
        ...
        public static string CostLookupPages()
        {
            ...
            if (totPages > 50)
            {
                output = "Need a custom quote";
            } else
            {
                switch (totPages)
                {
                    case 0:
                        output = (Cost.PageCost["Zero"]*Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 0 && n <= 5):
                        output = (Cost.PageCost["1To5"] * Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 5 && n <= 10):
                        output = (Cost.PageCost["6To10"] * Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 10 && n <= 20):
                        output = (Cost.PageCost["11To20"] * Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 20 && n <= 30):    
                        output = (Cost.PageCost["21To30"] * Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 30 && n <= 40):
                        output = (Cost.PageCost["31To40"] * Cost.Hourly()).ToString();
                        break;
                    case int n when (n > 40 && n <= 50):
                        output = (Cost.PageCost["41To50"] * Cost.Hourly()).ToString();
                        break;
        ...
        public static string CostLookupFields()
        {
            string output = "Error Has Occured";
            ...
            } else
            {
                ...
                output = (lookupDict[lookupKey]*Cost.Hourly()).ToString();
            }
            return output;
        }
